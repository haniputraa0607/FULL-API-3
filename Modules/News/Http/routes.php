...
Route::group(['middleware' => ['auth:api','user_agent'], 'prefix' => 'api/news', 'middleware' => 'log_activities', 'namespace' => 'Modules\News\Http\Controllers'], function()
{
    Route::any('list', 'ApiNews@listNews');
    Route::any('category', 'ApiNewsCategoryController@index');
});

Route::group(['prefix' => 'api/news', 'middleware' => ['log_activities', 'auth:api','user_agent'], 'namespace' => 'Modules\News\Http\Controllers'], function()
{
