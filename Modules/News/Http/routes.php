...
Route::group(['prefix' => 'api/news', 'middleware' => 'log_activities_apps', 'namespace' => 'Modules\News\Http\Controllers'], function()
{
...
Route::group(['prefix' => 'api/news', 'middleware' => ['log_activities_apps', 'auth:api'], 'namespace' => 'Modules\News\Http\Controllers'], function()
{
