...
Route::group(['prefix' => 'api/product','middleware' => 'log_activities_apps', 'namespace' => 'Modules\Product\Http\Controllers'], function()
{
    /**
     * product
     */
    ...
    Route::group(['middleware' => 'auth:api'], function() {
        ...
        Route::group(['middleware' => 'log_activities_apps'], function() {
