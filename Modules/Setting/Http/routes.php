...
Route::group(['middleware' => ['api', 'log_activities_apps'], 'prefix' => 'api/setting', 'namespace' => 'Modules\Setting\Http\Controllers'], function()
{
    Route::get('/courier', 'ApiSetting@settingCourier');
});

Route::group(['middleware' => ['auth:api', 'log_activities_apps'], 'prefix' => 'api/setting', 'namespace' => 'Modules\Setting\Http\Controllers'], function()
{
...
Route::group(['middleware' => ['api', 'log_activities_apps'], 'prefix' => 'api/timesetting', 'namespace' => 'Modules\Setting\Http\Controllers'], function()
{
	Route::get('/', 'ApiGreetings@listTimeSetting');
	Route::post('/', 'ApiGreetings@updateTimeSetting');
});

Route::group(['middleware' => ['api','log_activities_apps'], 'prefix' => 'api/background', 'namespace' => 'Modules\Setting\Http\Controllers'], function()
{
...
Route::group(['middleware' => ['api', 'log_activities_apps'], 'prefix' => 'api/greetings', 'namespace' => 'Modules\Setting\Http\Controllers'], function()
{
...
Route::group(['middleware' => ['auth_client', 'log_activities_apps'], 'prefix' => 'api/setting', 'namespace' => 'Modules\Setting\Http\Controllers'], function()
{
    Route::any('/', 'ApiSetting@settingList');
...
Route::group(['prefix' => 'api/setting', 'middleware' => ['log_activities_apps', 'auth:api'], 'namespace' => 'Modules\Setting\Http\Controllers'], function()
{
    Route::get('/faq', 'ApiSetting@faqList');
