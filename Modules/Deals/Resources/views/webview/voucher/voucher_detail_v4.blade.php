			...
			<div class="col-md-4 col-md-offset-4" style="background-color: #f8f9fb;">
				...
				<div style="background-color: #ffffff;padding: 10px;box-shadow: 0 0.7px 3.3px #eeeeee;height: 190px;" class="col-md-12 clearfix WorkSans">
					...
					<div style="position: relative;margin-top: 26.7px;">
						...
						<img src="{{ env('STORAGE_URL_API').$voucher['deal_voucher']['deal']['deals_image'] }}" alt="" style="width: 85px;position: absolute;border-radius: 50%;top: 14.5%;left: 6.5%;">
						<img style="width:100%" height="130px" src="{{ env('STORAGE_URL_API')}}img/asset/bg_item_kupon_saya.png" alt="">
					</div>
				</div>
