...
class Create extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'deals_start'               => 'sometimes|nullable|date|date_format:"Y-m-d"|after_or_equal:'.date('Y-m-d').'',
            'deals_end'                 => 'sometimes|nullable|date|date_format:"Y-m-d"|after_or_equal:deals_start',
            'deals_publish_start'       => 'sometimes|nullable|date|date_format:"Y-m-d"',
            'deals_publish_end'         => 'sometimes|nullable|date|date_format:"Y-m-d"|after_or_equal:deals_publish_start',
            'deals_voucher_duration'    => '',
            'deals_voucher_expired'     => 'nullable|date|date_format:"Y-m-d"|after:'.date('Y-m-d').'',
