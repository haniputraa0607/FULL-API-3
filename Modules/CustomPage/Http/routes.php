...
Route::group(['middleware' => ['auth:api-be', 'log_activities'], 'prefix' => 'api/custom-page', 'namespace' => 'Modules\CustomPage\Http\Controllers'], function () {
    Route::get('be/list', 'ApiCustomPageController@index');
