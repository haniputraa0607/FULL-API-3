...
Route::group(['middleware' => ['auth:api'],'prefix' => 'api/transaction', 'namespace' => 'Modules\Transaction\Http\Controllers'], function () {
    ...
    Route::any('available-delivery', 'ApiOnlineTransaction@availableDeliveryForApps');
    Route::get('be/available-delivery', 'ApiOnlineTransaction@availableDelivery')->middleware('scopes:be');
