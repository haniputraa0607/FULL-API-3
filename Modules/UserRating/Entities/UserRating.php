...
class UserRating extends Model
{
    ...
    protected $fillable = ['id_user','id_transaction', 'id_transaction_consultation', 'id_transaction_product_service','id_outlet','id_product','id_doctor','option_question','rating_value','suggestion','option_value'];
