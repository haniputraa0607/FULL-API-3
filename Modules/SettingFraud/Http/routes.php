...
Route::group(['middleware' => ['auth:api-be','log_activities'], 'prefix' => 'api/setting-fraud', 'namespace' => 'Modules\SettingFraud\Http\Controllers'], function()
{
...
Route::group(['middleware' => ['auth:api-be','log_activities'], 'prefix' => 'api/fraud', 'namespace' => 'Modules\SettingFraud\Http\Controllers'], function()
{
