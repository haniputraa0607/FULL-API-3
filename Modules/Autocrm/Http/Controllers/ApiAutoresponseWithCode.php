...
class ApiAutoresponseWithCode extends Controller
{
	...
	public function store(Request $request){
		...
		if(isset($post['autoresponse_code_name']) && !empty($post['autoresponse_code_name']) &&
    ...
    public function getAvailableCode($id_transaction){
        ...
        $detailTrx = Transaction::leftJoin('transaction_pickups', 'transaction_pickups.id_transaction', 'transactions.id_transaction')
            ...
            ->select('transactions.trasaction_type', 'transactions.id_user', 'transaction_pickups.pickup_by',
                'transaction_payment_midtrans.payment_type', 'transaction_payment_ipay88s.payment_method', 'transaction_payment_midtrans.gross_amount',
