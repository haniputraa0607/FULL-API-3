...
Route::group(['middleware' => ['auth:api', 'log_activities', 'user_agent'], 'prefix' => 'api/balance', 'namespace' => 'Modules\Balance\Http\Controllers'], function()
{
...
Route::group(['middleware' => ['auth:api', 'log_activities', 'user_agent'], 'prefix' => 'api/v1/pos/saldo', 'namespace' => 'Modules\Balance\Http\Controllers'], function()
{
