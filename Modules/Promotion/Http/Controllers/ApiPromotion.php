		...
		if(isset($post['promotion_series_days'])){
			foreach($post['promotion_series_days'] as $key => $row){
				...
				if(isset($post['promotion_channel'][$key]) && in_array('deals', $post['promotion_channel'][$key])){
					...
					$dataDeals['deals_start'] = date('Y-m-d H:i:00', strtotime($post['deals_start'][$key]));
					$dataDeals['deals_end'] = date('Y-m-d H:i:00', strtotime($post['deals_end'][$key]));
					if($post['duration'][$key] == "duration"){
						...
						$dataDeals['deals_voucher_expired'] = date('Y-m-d H:i:00', strtotime($post['deals_voucher_expiry_bydate'][$key]));
					}
			...
			if(isset($post['promotion_channel'][0]) && in_array('deals', $post['promotion_channel'][0])){
				...
				$dataDeals['deals_short_description'] = "This hidden deals is auto-generated from Promotion '".$promotion['promotion_name']."'";
				$dataDeals['deals_image'] = "";
				$dataDeals['deals_start'] = date('Y-m-d H:i:00', strtotime($post['deals_start'][0]));
				$dataDeals['deals_end'] = date('Y-m-d H:i:00', strtotime($post['deals_end'][0]));
				if($post['duration'][0] == "duration"){
					...
					$dataDeals['deals_voucher_duration'] = null;
					$dataDeals['deals_voucher_expired'] = date('Y-m-d H:i:00', strtotime($post['deals_voucher_expiry_bydate'][0]));
				}
